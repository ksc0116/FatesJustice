...
namespace ZeldaEngine
{
	...
	void Initialize(_In_ HINSTANCE hInstance, LPCWSTR gamename, _In_ int nCmdShow, unsigned int width, unsigned int height, bool screenresizeable)
	{
		// 엔진의 컴포넌트 등록
		...
		CoreSystem::GetInstance().Initialize(hInstance, gamename, width, height, screenresizeable);
