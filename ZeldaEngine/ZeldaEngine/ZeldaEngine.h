...
{
	ZELDAENGINE_API void Initialize(_In_ HINSTANCE hInstance, LPCWSTR gamename, _In_ int nCmdShow, unsigned int width, unsigned int height, bool screenresizeable = true);
