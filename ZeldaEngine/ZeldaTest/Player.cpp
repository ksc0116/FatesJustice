...
void Player::Start()
{
	...
	//playerAttackAxis->GetTransform()->AddChild(playerAttackCylinder->GetTransform());
	//playerAttackAxis->GetTransform()->AddChild(playerAttackCube1->GetTransform());
	//playerAttackAxis->GetTransform()->AddChild(playerAttackCube2->GetTransform());
	...
	//playerAttackCylinder->SetActive(false);
	//playerAttackCube1->SetActive(false);
	//playerAttackCube2->SetActive(false);
	//
	//playerAttackCylinder->GetTransform()->SetLocalScale(Vector3D(25, 25, 25));
	//playerAttackCylinder->GetTransform()->SetLocalPosition(playerAttackAxis->GetTransform()->GetLocalPosition());
	//MeshRenderer* normalAttack = playerAttackCylinder->AddComponent<MeshRenderer>();
	//normalAttack->SetMesh(L"Cylinder");
	//normalAttack->SetMaterial(L"BoundaryDebug");
	//normalAttackCheck = playerAttackCylinder->AddComponent<CylinderCollider>();
	//normalAttackCheck->SetTrigger(true);
	//
	//playerAttackCube1->GetTransform()->SetLocalScale(Vector3D(15, 25, 30));
	//playerAttackCube1->GetTransform()->SetLocalPosition(playerAttackAxis->GetTransform()->GetLocalPosition() + Vector3D(-7.5, 0, -7.5));
	//playerAttackCube1->GetTransform()->SetLocalRotation(playerAttackAxis->GetTransform()->GetLocalRotation());
	//playerAttackCube1->GetTransform()->Rotate(playerAttackAxis->GetTransform()->GetUp(), DegreeToRadian(-80));
	//MeshRenderer* exceptAttackRange1 = playerAttackCube1->AddComponent<MeshRenderer>();
	//exceptAttackRange1->SetMesh(L"Cube");
	//exceptAttackRange1->SetMaterial(L"BoundaryDebug");
	//exceptAttackCheck1 = playerAttackCube1->AddComponent<CubeCollider>();
	//exceptAttackCheck1->SetTrigger(true);
	//
	//playerAttackCube2->GetTransform()->SetLocalScale(Vector3D(15, 25, 30));
	//playerAttackCube2->GetTransform()->SetLocalPosition(playerAttackAxis->GetTransform()->GetLocalPosition() + Vector3D(7.5, 0, -7.5));
	//playerAttackCube2->GetTransform()->SetLocalRotation(playerAttackAxis->GetTransform()->GetLocalRotation());
	//playerAttackCube2->GetTransform()->Rotate(playerAttackAxis->GetTransform()->GetUp(), DegreeToRadian(80));
	//MeshRenderer* exceptAttackRange2 = playerAttackCube2->AddComponent<MeshRenderer>();
	//exceptAttackRange2->SetMesh(L"Cube");
	//exceptAttackRange2->SetMaterial(L"BoundaryDebug");
	//exceptAttackCheck2 = playerAttackCube2->AddComponent<CubeCollider>();
	//exceptAttackCheck2->SetTrigger(true);
	...
	playerSpecialAttack->GetTransform()->SetLocalScale(Vector3D(8, 10, 10));
	playerSpecialAttack->GetTransform()->SetLocalPosition(playerAttackAxis->GetTransform()->GetLocalPosition() + Vector3D(0, 0, 5.0f));
	...
	playerFSM.transitions[PlayerState::Attack].push_back({ PlayerState::Idle,
		[this]() {return !Input::GetInstance().PressedKey(attackKey) && normalAttackTime >= AttackMotionDelay; } });
	...
	playerFSM.transitions[PlayerState::SpecialAttack].push_back({ PlayerState::Idle,
		[this]() {return !Input::GetInstance().PressedKey(specialAttackKey) && specialAttackChargingTime >= SpecialAttackMotionDelay; } });
...
\
	...
	// 쿨타임 시간을 업데이트 시킨다.
	TimeEvent(deltaTime);
	/// 밀려나는 힘 디버깅용 추후에 삭제할 것
	//if(Input::GetInstance().PressedKeyNow('1'))
	//{
	...
	//}
	//if (Input::GetInstance().PressedKeyNow('2'))
	//{
	//	force += 0.5f;
	//}
	//if (Input::GetInstance().PressedKeyNow('3'))
	//{
	//	force -= 0.5f;
	//}
	//OutputDebugString((std::to_wstring(force) + L"\n").c_str());
}
...
void Player::AttackEvent()
{
	if (normalAttackTime >= normalAttackCoolTime)
	{
		...
		//playerAttackCylinder->SetActive(true);
		//playerAttackCube1->SetActive(true);
		//playerAttackCube2->SetActive(true);
...
void Player::SpecialAttackEvent()
{
	...
	if (specialAttackChargingTime >= spacialAttackCoolTime)
	{
		...
		playerDotween->DONothing(attackDelay).OnComplete([=]()
			{
				playerSpecialAttack->SetActive(false);
		playerSpecialAttack->GetTransform()->SetLocalPosition(Vector3D(0, 0, 10.0f));
