...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	Initialize(hInstance, gamename.c_str(), nCmdShow, 1920, 1080, false);
...
#pragma region Player
		...
		playerSpecialAttackEffect->SetPlaySpeed(1.0f);
...
#pragma endregion
	...
	else if (x == SC)
	{
...

		{
			...
			particle->GetTransform()->SetLocalPosition(Vector3D(0,4.0f,0));
		...
		for (int i = 0; i < 1; ++i)
		{
			...
			FF::FFAnimationClip& clip = GetAnimationClip(L"root|007-2.Skill_ChargeAttack");
			clip.isLoop = true;
			...
			anim->Play(L"root|007-2.Skill_ChargeAttack");
		}
				...
				// 설정 UI
				{
					...
					// SoundBar
					{
						...
						// SoundBarText
						{
							...
							soundText_texture->SetLayer(900);
						}
					}
